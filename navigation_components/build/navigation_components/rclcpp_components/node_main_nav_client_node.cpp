...
#define NODE_MAIN_LOGGER_NAME "nav_client_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libnav_client_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<NavClient>";
