...
#define NODE_MAIN_LOGGER_NAME "nav_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libnav_server_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<NavServer>";
