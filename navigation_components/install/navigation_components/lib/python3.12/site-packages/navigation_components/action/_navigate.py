...
class Metaclass_Navigate_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('navigation_components')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_Goal')
            logger.debug(
...
class Metaclass_Navigate_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from navigation_components.action import Navigate
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'navigation_components/Navigate_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from navigation_components.action._navigate import Navigate_Goal
...
class Navigate_SendGoal_Event(metaclass=Metaclass_Navigate_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<navigation_components/Navigate_SendGoal_Request, 1>',
        'response': 'sequence<navigation_components/Navigate_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from navigation_components.action import Navigate_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from navigation_components.action import Navigate_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from navigation_components.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from navigation_components.action._navigate import Navigate_SendGoal_Request as Request
    from navigation_components.action._navigate import Navigate_SendGoal_Response as Response
    from navigation_components.action._navigate import Navigate_SendGoal_Event as Event
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'navigation_components/Navigate_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from navigation_components.action._navigate import Navigate_Result
...
class Navigate_GetResult_Event(metaclass=Metaclass_Navigate_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<navigation_components/Navigate_GetResult_Request, 1>',
        'response': 'sequence<navigation_components/Navigate_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from navigation_components.action import Navigate_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from navigation_components.action import Navigate_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from navigation_components.action._navigate import Navigate_GetResult_Request as Request
    from navigation_components.action._navigate import Navigate_GetResult_Response as Response
    from navigation_components.action._navigate import Navigate_GetResult_Event as Event
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'navigation_components/Navigate_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['navigation_components', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from navigation_components.action._navigate import Navigate_Feedback
...
class Metaclass_Navigate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_components.action.Navigate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from navigation_components.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from navigation_components.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from navigation_components.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from navigation_components.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from navigation_components.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from navigation_components.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
