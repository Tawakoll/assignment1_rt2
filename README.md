A ROS 2 package implementing an Action Server/Client architecture for 2D robot navigation. It allows users to send `(x, y, theta)` goals to a differential drive robot, supporting goal cancellation.
